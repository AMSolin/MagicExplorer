...
import page_import, page_collections, page_players, page_initialization, page_import_delver
from utils import *
...
def main():
	...
	menu = ['Init', 'Cards', 'Import', 'Delver', 'Players', 'Collections', 'Decks']
	...
	if choice == 'Delver':
		page_import_delver.get_content()
main()
